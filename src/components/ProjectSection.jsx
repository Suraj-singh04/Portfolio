  ...
  return (
    <section id="projects" className="py-20 bg-gray-50">
      <div className="container mx-auto xl:px-20 px-4">
        {/* Section Heading */}
        <div className="max-w-3xl flex flex-col items-center mx-auto mb-16 text-center">
            ...
            <button
              ...
              className={`${
                activeFilter === category
                  ...
                  : "border border-purple-700 text-purple-600 hover:bg-purple-600 hover:text-white"
              } capitalize px-4 py-2 rounded-md transition-all duration-300`}
            >
...
function ProjectCard({ project }) {
  return (
    <div className="overflow-hidden rounded-md border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 h-full flex flex-col">
